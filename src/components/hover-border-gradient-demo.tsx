...
export default function HoverBorderGradientDemo() {
    return (
        <div className='md:translate-y-0 w-full rounded-md bg-black relative flex flex-col items-center justify-center antialiased'>
            <h1 className='mt-30 relative z-10 text-4xl md:text-7xl text-transparent [-webkit-text-stroke:0.4px_silver] text-center font-sans font-bold'>
                Upcoming
            </h1>
            <h1 className='mt-10 relative z-10 text-4xl md:text-7xl bg-clip-text text-transparent text-center font-sans font-bold'>
                ...
                <div className='flex flex-col items-center md:hidden'>
                    ...
                    <Image
                        ...
                        className='h-10 w-auto my-2'
                    />
                    <span className='bg-clip-text bg-gradient-to-t from-neutral-200 to-neutral-600'>
                        Crowdsource
                    </span>
                </div>
            ...
            <div className='w-full px-4 grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4'>
                ...
                <div className='order-1 md:order-2 flex flex-col justify-center'>
                    <p className='text-neutral-400 max-w-lg mx-auto mt-2 text-md text-center relative z-10'>
                        <br />
                        Join us for an exciting two-hour interactive workshop/
                        hands-on session powered by Google Crowdsource, where
                        you&apos;ll discover how Google trains it&apos;s AI
                        models, even how you can help train & improve
                        Google&apos;s AI - no coding required!
                        <br />
                        <br />
                        ...
                        This is your chance to network with industry
                        specialists, understand how big techs like Google train
                        and improve their AI systems. Don&apos;t miss out!
                        <br />
                        <br />
                    </p>
